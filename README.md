...
This project is a project to study Flutter and MobX.

## Description

There is a grid list to view items, and click in a item go to detail page and view more informations
about item selected.
